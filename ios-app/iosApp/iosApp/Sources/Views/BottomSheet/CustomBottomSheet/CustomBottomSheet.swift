...
public struct CustomBottomSheet<Content : View>: IBottomSheetView {

    private typealias Position = CustomBottomSheetPosition

    /// Offset relatively the base
    @State private var offset: CGFloat = 0

    /// Current position
    @State private var position: CustomBottomSheetPosition
...
// MARK: - Config
    ...
    public var body: some View {
        GeometryReader { proxy in
            ...
            .preference(key: CustomBottomSheetPositionKey.self, value: position)
...
public extension CustomBottomSheet {
    ...
    /// - Returns: View
    func onPositionChanged(_ fn: @escaping (CustomBottomSheetPosition) -> ()) -> some View {
        self.onPreferenceChange(CustomBottomSheetPositionKey.self) {
            fn($0)
        }
    }
}
    ...
    struct BottomSheet_Previews: PreviewProvider {
        static var previews: some View {
            ZStack {
                CustomBottomSheet(content: Color.clear.background(.thinMaterial))
            }
        }
    }
#endif
