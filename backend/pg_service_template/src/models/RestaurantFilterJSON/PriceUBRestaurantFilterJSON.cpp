#include "PriceUBRestaurantFilterJSON.hpp"
...
namespace service {
    ...
    const std::string PriceUBRestaurantFilterJSON::kFieldName_ = "price_upper_bound";
    const std::unordered_map<std::string, std::string> PriceUBRestaurantFilterJSON::kCorrectOperators_ = {
            {"lt", "<"},
            {"gt", ">"},
            {"ge", ">="},
            {"le", "<="},
    ...
    std::variant<std::string, ErrorDescriprion> PriceUBRestaurantFilterJSON::BuildSQLFilter(
